...
1. [We would like to add recipients to the reports distro list, how can we add them?](#we-would-like-to-add-recipients-to-the-reports-distro-list-how-can-we-add-them)
1. [When does the Cyber Hygiene Vulnerability scan start?](#when-does-the-cyber-hygiene-vulnerability-scan-start)
1. [How does DHS protect the confidentiality of the report?](#how-does-dhs-protect-the-confidentiality-of-the-report)
1. [What information does DHS disclose about the participants of the program?  Would our agency be publicly identified as a participant?](#what-information-does-dhs-disclose-about-the-participants-of-the-program--would-our-agency-be-publicly-identified-as-a-participant)
1. [Who/What entities have access to the findings of the reports?](#whowhat-entities-have-access-to-the-findings-of-the-reports)
1. [How does DHS anonymize the data collected for use in supplemental reports?](#how-does-dhs-anonymize-the-data-collected-for-use-in-supplemental-reports)
1. [On page two in the Cyber Hygiene agreement you mention 'You accept that your Agency bears the risk to its systems and networks described above.' Can you help me understand your definition of this line? If the scan is non-intrusive, then what risks would?](#on-page-two-in-the-cyber-hygiene-agreement-you-mention-you-accept-that-your-agency-bears-the-risk-to-its-systems-and-networks-described-above-can-you-help-me-understand-your-definition-of-this-line-if-the-scan-is-non-intrusive-then-what-risks-would)
1. [Are there any baseline statistics available that show of the average number of vulnerabilities per organization / host and the average days to remediate?](#are-there-any-baseline-statistics-available-that-show-of-the-average-number-of-vulnerabilities-per-organization--host-and-the-average-days-to-remediate)
1. [Can we change the language on the NCATS legal agreements? ?](#can-we-change-the-language-on-the-ncats-legal-agreements)
1. [Can NCATS sign a Non-Disclosure Agreement (NDA)?](#can-ncats-sign-a-non-disclosure-agreement-nda)
1. [Why are there more Mitigated Vulnerabilities than Detected Vulnerabilities in a single year?](#why-are-there-more-mitigated-vulnerabilities-than-detected-vulnerabilities-in-a-single-year)
1. [What does CIDR notation mean?](#what-does-cidr-notation-mean)
1. [Are my reports subject to FOIA requests?](#are-my-reports-subject-to-foia-requests)
1. [Can I have a copy of our  counter signed ROE?](#can-i-have-a-copy-of-our--counter-signed-roe)
1. [I would like to understand the SecureDNS Validation report error correction process.](#i-would-like-to-understand-the-securedns-validation-report-error-correction-process)
1. [DNSSEC address conflict canned language.](#dnssec-address-conflict-canned-language)
1. [Can we report a potential false positive?](#can-we-report-a-potential-false-positive)
1. [Will you add our private certificate authority in your root store?/ Trust Issues.](#will-you-add-our-private-certificate-authority-in-your-root-store-trust-issues)
1. [Why would a vulnerability appear in one scan and not another?](#why-would-a-vulnerability-appear-in-one-scan-and-not-another)
1. [Certificate Authorities (CA)](#certificate-authorities-ca)
1. [M-15-01 Semi-annual Data Request.](#m-15-01-semi-annual-data-request)
1. [M-15-01.](#m-15-01)
1. [We have noticed scanning activity coming from 64.69.57.0/24 and or AWS. Can you confirm this traffic?](#we-have-noticed-scanning-activity-coming-from-646957024-and-or-aws-can-you-confirm-this-traffic)
1. [Can you scan domains/AWS (Dynamic IP addresses/Cloud-hosted resources)?](#can-you-scan-domainsaws-dynamic-ip-addressescloud-hosted-resources)
1. [Do you know when you will be able to scan IPv6 space?](#do-you-know-when-you-will-be-able-to-scan-ipv6-space)
1. [I am seeing fluctuations in host counts, why is that?](#i-am-seeing-fluctuations-in-host-counts-why-is-that)
1. [OS MISIDENTIFICATION and NMAP.](#os-misidentification-and-nmap)
1. [NCATS/CyHy Authority To Operate.](#ncatscyhy-authority-to-operate)
1. [Are there any risks associated with network scanning?](#are-there-any-risks-associated-with-network-scanning)
1. [How long does the scanning usually take? ](#how-long-does-the-scanning-usually-take)
1. [Why can't you scan domains?](#why-cant-you-scan-domains)
1. [I am receiving reports about service impacts due to CyHy scanning against one of our Agency VPN systems?](#i-am-receiving-reports-about-service-impacts-due-to-cyhy-scanning-against-one-of-our-agency-vpn-systems)
1. [Why are we being hit with so much traffic?](#why-are-we-being-hit-with-so-much-traffic)
1. [What IP addresses do we send you?](#what-ip-addresses-do-we-send-you)
1. [Can the testing be scheduled for a particular time-period?](#can-the-testing-be-scheduled-for-a-particular-time-period)
1. [What do you define as a "host"?](#what-do-you-define-as-a-host)
1. [Why is my report blank?](#why-is-my-report-blank)
1. [I would like this domain removed from my HTTPS Report.](#i-would-like-this-domain-removed-from-my-https-report)
1. [Why are there some hosts not showing up on the report?](#why-are-there-some-hosts-not-showing-up-on-the-report)
1. [I am concerned with seeing one of our public host addresses being identified on the geo-location map as being in the state of Kansas. Would it be possible to tell me which IP address is responding from that location?](#i-am-concerned-with-seeing-one-of-our-public-host-addresses-being-identified-on-the-geo-location-map-as-being-in-the-state-of-kansas-would-it-be-possible-to-tell-me-which-ip-address-is-responding-from-that-location)
1. [Can you share the raw .nessus file for the Cyber Hygiene reports?](#can-you-share-the-raw-nessus-file-for-the-cyber-hygiene-reports)
1. [Can you please provide us with a CVE number for the vulnerability that was detected in our latest report?](#can-you-please-provide-us-with-a-cve-number-for-the-vulnerability-that-was-detected-in-our-latest-report)
1. [Why is the vulnerability severity in our Cyber Hygiene report different from the severity listed on the Nessus plugin website?](#why-is-the-vulnerability-severity-in-our-cyber-hygiene-report-different-from-the-severity-listed-on-the-nessus-plugin-website)
1. [I see vulnerability scanning is now coming from AWS, not your 64 network as previously specified, why?](#i-see-vulnerability-scanning-is-now-coming-from-aws-not-your-64-network-as-previously-specified-why)
1. [How should I handle your scanning traffic? Should I whitelist your source IPs especially since you are scanning from AWS?](#how-should-i-handle-your-scanning-traffic-should-i-whitelist-your-source-ips-especially-since-you-are-scanning-from-aws)
1. [Details about Third Party Authorization.](#details-about-third-party-authorization)
1. [Can you rescan us?](#can-you-rescan-us)
1. [Does *domain* need an SPF/DMARC record?](#does-domain-need-an-spfdmarc-record)
1. [Why aren't you scanning for DKIM?](#why-arent-you-scanning-for-dkim)
1. [More Trustworthy Email Information:](#more-trustworthy-email-information)
1. [Why aren't all subdomain details provided?](#why-arent-all-subdomain-details-provided)
1. [What are email authentication technologies, and what do they do?](#what-are-email-authentication-technologies-and-what-do-they-do)
1. [What does the Trustworthy Email report tell me?](#what-does-the-trustworthy-email-report-tell-me)
1. [What should my organization do?](#what-should-my-organization-do)
1. [How do I implement email authentication?](#how-do-i-implement-email-authentication)
1. [What should I do with domains that don't send mail?](#what-should-i-do-with-domains-that-dont-send-mail)
1. [Can email authentication hinder my organization's ability to deliver email?](#can-email-authentication-hinder-my-organizations-ability-to-deliver-email)
1. [What is the logic behind determining BOD 18-01 Email Security Compliance?](#what-is-the-logic-behind-determining-bod-18-01-email-security-compliance)
